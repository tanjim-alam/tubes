...
import instagramReelsLikesData from "../../constant/instagram/instagramReelsLikesData.json";
...
function InstagramReelsLikesPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Instagram Reels <br/> Likes with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Likes</span></h3>"} imgUrl={"https://i0.wp.com/vietnaminsider.vn/wp-content/uploads/2024/07/Screen-Shot-2024-07-30-at-00.05.14.png?resize=750%2C494&ssl=14"} />
            ...
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    ...
                    <ServiceCard packageData={instagramReelsLikesData} />
                </div>
            </div>
            {/* package section end */}
            {/* <PackageSection /> */}
