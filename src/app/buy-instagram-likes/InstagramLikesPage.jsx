...
import instagramLikesData from "../../constant/instagram/instagramLikesData.json";
...
function InstagramLikesPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Instagram Likes <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Likes</span></h3>"} imgUrl={"https://i0.wp.com/vietnaminsider.vn/wp-content/uploads/2024/07/Screen-Shot-2024-07-30-at-00.05.14.png?resize=750%2C494&ssl=14"} />
            {/* package section start */}
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start font-semibold'>Buy Instagram Likes to Boost Engagements!</h3>
                        <p className='lg:text-xl text-lg text-center lg:text-start font-medium'>Get Real Instagram Likes and Boost Your Profile Impressions.</p>
                    </div>
                    <ServiceCard packageData={instagramLikesData} />
                </div>
            </div>
            {/* package section end */}
            {/* <PackageSection /> */}
