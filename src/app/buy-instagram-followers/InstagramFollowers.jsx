...
import instagramFollowersData from "../../constant/instagram/instagramFollowersData.json";
...
function InstagramFollowersPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Instagram Followers <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Followers</span></h3>"} imgUrl={"https://i0.wp.com/vietnaminsider.vn/wp-content/uploads/2024/07/Screen-Shot-2024-07-30-at-00.05.14.png?resize=750%2C494&ssl=14"} />
            {/* package section start */}
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start font-semibold'>Buy Instagram Followers to Boost Engagements!</h3>
                        <p className='lg:text-xl text-lg text-center lg:text-start font-medium'>Get Real Instagram Followers and Boost Your Profile Impressions.</p>
                    </div>
                    <ServiceCard packageData={instagramFollowersData} />
                </div>
            </div>
            {/* package section end */}
            {/* <PackageSection /> */}
